...
namespace Sol_PuntoVenta.Presentacion
{
    public partial class Frm_Productos : Form
    {
        ...
        {
            txt_descipcion_sf.Text = "";
            txt_descipcion_um.Text = "";
        }
        ...
        {
            txt_descipcion_sf.ReadOnly = !lEstado;
        }
        ...
        private void Selecciona_Item()
        {
            ...
            else
            {
                ...
                txt_descipcion_sf.Text = Convert.ToString(Dgv_Listado.CurrentRow.Cells["descripcion_sf"].Value);
                txt_descipcion_um.Text = Convert.ToString(Dgv_Listado.CurrentRow.Cells["descripcion_fa"].Value);
        ...
        private void Selecciona_Item_fa()
        {
            ...
            {
                txt_descipcion_um.Text = Convert.ToString((dgv_1.CurrentRow.Cells["descripcion_fa"].Value));
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            try
            {
                if (txt_descipcion_sf.Text == String.Empty|| 
                    txt_descipcion_um.Text == string.Empty)
                {
                    ...
                    oPropiedad.Descripcion_sf = txt_descipcion_sf.Text.Trim();
        ...
        {
            pnl_listado1.Location = Btn_um.Location;
