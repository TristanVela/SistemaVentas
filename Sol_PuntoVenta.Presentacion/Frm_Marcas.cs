...
namespace Sol_PuntoVenta.Presentacion
{
    public partial class Frm_Marcas : Form
    {
        ...
        private void Listado_ma(string cTexto)
        {
            try
            {
                Dgv_Listado.DataSource = N_Marcas.Litado_ma(cTexto);
                this.Formato_ma();
        ...
        private void Selecciona_Item()
        {
            ...
            else
            {
                ...
                txtDescripcion.Text = Convert.ToString((Dgv_Listado.CurrentRow.Cells["descripcion_ma"].Value));
            }
        }
        #endregion
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtDescripcion.Text == String.Empty)
                {
                    ...
                    oPropiedad.Descripcion_ma = txtDescripcion.Text.Trim();
